...
//		Actions builder = new Actions(driver);
        ...
        System.out.println("Check Box displayed by default? "+chkBox.isDisplayed());
        toggleButton.click();
        System.out.println("Check Box displayed after clicking toggle button? "+chkBox.isDisplayed());
